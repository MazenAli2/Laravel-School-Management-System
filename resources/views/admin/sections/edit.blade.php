                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('admin.sections.update', $section) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $section->name)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="capacity" class="block mt-1 w-full" type="number" name="capacity" :value="old('capacity', $section->capacity)" required min="1" />
