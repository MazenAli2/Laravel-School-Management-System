                        ...
                        @forelse ($students as $student)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-right">
                                    ...
                                    <form action="{{ route('admin.students.destroy', $student) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this student? This will also delete the associated user account.');">
                                        @csrf
                                        @method('DELETE')
