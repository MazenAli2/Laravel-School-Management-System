                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.students.update', $student) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $student->user->name)" required autofocus autocomplete="name" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $student->user->email)" required autocomplete="username" />
                        ...
                        <div class="mt-4">
                            ...
                            <select id="guardian_id" name="guardian_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                @foreach($guardians as $guardian)
                                    <option value="{{ $guardian->id }}" {{ old('guardian_id', $student->guardian_id) == $guardian->id ? 'selected' : '' }}>{{ $guardian->user->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="admission_date" class="block mt-1 w-full" type="date" name="admission_date" :value="old('admission_date', $student->admission_date)" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="roll_number" class="block mt-1 w-full" type="text" name="roll_number" :value="old('roll_number', $student->roll_number)" required />
